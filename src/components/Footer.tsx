      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-6 md:mb-0">
            <Link to="/" className="text-black font-medium text-xl tracking-tight hover:opacity-80 transition-opacity duration-200">
              Shubham's PDF Reader
            </Link>
            <p className="mt-2 text-sm text-black/60 max-w-md">
              An AI-powered tool for intelligently interacting with PDF documents through natural conversation.
            </p>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-8 md:gap-16">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li>
                  <Link to="/chat" className="text-sm text-black/60 hover:text-black transition-colors">
                    Chat Interface
                  </Link>
                </li>
                <li>
        ...
        <div className="mt-12 pt-6 border-t border-black/5 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-black/50">
            © {currentYear} Shubham's PDF Reader. All rights reserved.
          </p>
